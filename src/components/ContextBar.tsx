  ...
  return (
    <div className="sticky top-0 z-30 w-full glass-card border-x-0 border-t-0 rounded-none h-14 hidden md:flex items-center px-2 sm:px-6 gap-2 sm:gap-4 overflow-x-auto no-scrollbar">
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 min-h-[44px] md:min-h-[38px] rounded-lg bg-surface hover:bg-brand-purple-800/50 border border-border-subtle transition-colors group shrink-0 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-pink-400 focus-visible:ring-offset-1 focus-visible:ring-offset-panel active:scale-95"
      >
        ...
        {BRANDS.map(b => (
          <button
            ...
            className={clsx(
              ...
              "px-2.5 sm:px-3 py-1.5 min-h-[44px] md:min-h-[34px] rounded-md text-[11px] font-bold uppercase tracking-widest transition-all cursor-pointer select-none focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-purple-400 focus-visible:ring-offset-1 focus-visible:ring-offset-black active:scale-95",
              currentBrand === b
          ...
          <>
            ...
            {(activeChips.length > 0 || currentBrand !== 'All') && (
              <button
                ...
                className="text-xs text-brand-pink-400 font-semibold hover:text-brand-pink-300 ml-2 whitespace-nowrap shrink-0 cursor-pointer px-2 py-1.5 min-h-[44px] md:min-h-0 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-pink-400 focus-visible:ring-offset-1 focus-visible:ring-offset-panel active:scale-95"
              >
                Clear all
              </button>
            )}
